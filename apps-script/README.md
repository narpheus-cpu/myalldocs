...
6. Script Properties에 서비스 계정 JSON의 `client_email`을 `SERVICE_ACCOUNT_EMAIL`로 추가합니다.
7. 권한 확인 화면에서 Drive 원본 읽기, 이 앱이 만든 비공개 관리 파일 쓰기, GitHub 요청, 완료 메일 발송 권한을 승인합니다.
